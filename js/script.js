$(window).on("load", function () {
    ...
    class ThreeBoardEffect {
        constructor() {
            ...
            if (that3.stickyHeight.length > 0 && window.innerWidth > 1000) {
                that3.init();
            }
        }
    ...
    class ThreeBoardEffectAgain {
        constructor() {
            ...
            if ( that3Again.stickyHeight.length > 0 && window.innerWidth > 1000) {
                that3Again.init();
            }
        }
        ...
        windowScroll() {
            if (that3Again.stickyHeight.length > 0 && window.innerWidth > 1000) {
                ...
                if ($(window).scrollTop() <= that3Again.stickyHeight.offset().top) {
                    ...
                    goUp = goUp / 1.5 * 1;
                    boards.eq(0).css("transform", "translate(0px, " + goUp + "px)");
                    if (numBoards > 1) boards.eq(1).css("transform", "translate(0px, 0px)");
                } else if (numBoards > 1 && $(window).scrollTop() >= that3Again.stickyHeight.offset().top + window.innerHeight * 1.5 && $(window).scrollTop() <= that3Again.stickyHeight.offset().top + window.innerHeight * 3) {
                    boards.eq(0).css("transform", "translate(0px, " + (-(window.innerHeight)) + "px)");
                    var goUp = -($(window).scrollTop() - (that3Again.stickyHeight.offset().top + window.innerHeight * 1.5));
                    goUp = goUp / 1.5 * 1;
                    boards.eq(1).css("transform", "translate(0px, " + goUp + "px)");
                } else if (numBoards > 1 && $(window).scrollTop() >= that3Again.stickyHeight.offset().top + window.innerHeight * 3 && $(window).scrollTop() <= that3Again.stickyHeight.offset().top + window.innerHeight * 4.5) {
                    boards.eq(0).css("transform", "translate(0px, " + (-(window.innerHeight)) + "px)");
                    boards.eq(1).css("transform", "translate(0px, " + (-(window.innerHeight)) + "px)");
    ...
    class BlogEffect {
      constructor() {
        ...
        if(thatBlog.scrollContainer.length > 0 && window.innerWidth > 1000){
            thatBlog.init();
        }
